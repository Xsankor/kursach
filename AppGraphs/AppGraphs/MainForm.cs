...
namespace AppGraphs
{
    public partial class MainForm : Form
    {
        ...
        public MainForm()  
        {
            ...
            //chart1.ChartAreas[0].AxisX.Interval = (maxSizeEdge - minSizeEdge) / 2;
            //chart1.ChartAreas[0].AxisY.Interval = (maxSizeEdge - minSizeEdge) / 2;
        ...
        private void BuildGraph(int index)
        {
            ...
            for (double x = minSizeEdge; x <= maxSizeEdge; x += step)
            {
                x = Math.Round(x, 2);
                if (x == 0) continue;
                y = Math.Round(СalcFunction(x, index), 2);
        ...
        private void RevialCheckSeries()
        {
